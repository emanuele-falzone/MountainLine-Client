...
ViewModel.prototype.id = 'form-campaign-edit-details';
...
ViewModel.prototype._compute = function () {
    this.output = {
        ...
        'campaign_url': this.input['campaign_url'],
    }
    var self = this,
        fields = {
            ...
            'campaign_url': ko.observable(this.input['campaign_url']),
        },
        errors = {
            ...
            'campaign_url': ko.observable(this.input['campaign_url-error']),
        };
    ...
    fields['campaign_url'].subscribe(function (value) {
        self.output['campaign_url'] = value;
        self.errors()['campaign_url'](undefined);
    });
    this.fields(fields);
    this.errors(errors);
...
exports.register = function () {
    ko.components.register('c-form-campaign-edit-details', {
        viewModel: {
