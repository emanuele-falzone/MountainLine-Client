...
ViewModel.prototype.id = 'view-container-campaign-statistics';
ViewModel.prototype.children = [
    'details-campaign-statistics' // Statistics
];

exports.register = function () {
    ko.components.register('c-view-container-campaign-statistics', {
        viewModel: {
