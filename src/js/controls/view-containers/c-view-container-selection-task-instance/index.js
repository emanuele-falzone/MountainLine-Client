...
ViewModel.prototype.id = 'view-container-selection-task-instance';
ViewModel.prototype.children = [
    'form-image-selection' // Image Selection
];

exports.register = function () {
    ko.components.register('c-view-container-selection-task-instance', {
        viewModel: {
