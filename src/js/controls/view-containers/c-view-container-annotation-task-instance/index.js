...
ViewModel.prototype.id = 'view-container-annotation-task-instance';
ViewModel.prototype.children = [
    'form-image-annotation' // Image Annotation
];

exports.register = function () {
    ko.components.register('c-view-container-annotation-task-instance', {
        viewModel: {
