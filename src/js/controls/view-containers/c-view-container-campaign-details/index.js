...
ViewModel.prototype.id = 'view-container-campaign-details';
ViewModel.prototype.children = [
    'form-campaign-edit-details' // Campaign Details
];

exports.register = function () {
    ko.components.register('c-view-container-campaign-details', {
        viewModel: {
