...
function ViewModel(params) {
    var self = this;
    self._repository = params.context.repositories['CampaignStatistics'];
...
ViewModel.prototype.id = 'details-campaign-statistics';
...
exports.register = function () {
    ko.components.register('c-details-campaign-statistics', {
        viewModel: {
