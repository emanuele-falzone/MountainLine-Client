...
function ViewModel(params) {
    var self = this;
    self._repository = params.context.repositories['CampaignWorkerDetails'];
...
ViewModel.prototype.id = 'details-campaign-worker';
...
exports.register = function () {
    ko.components.register('c-details-campaign-worker', {
        viewModel: {
