...
function ViewModel(params) {
    var self = this;
    self._repository = params.context.repositories['TaskStatistics'];
    self.context = params.context;
    self.status = ko.observable('');
    self.item = ko.observable(undefined);
    self.annotation = ko.observable(false);
...
ViewModel.prototype.id = 'details-task-statistics';
...
ViewModel.prototype._compute = function() {
    ...
    this._computing = this._repository.findById(this.filters.id, this.fields).then(function (item) {
        ...
        } else if (item.accepted !== undefined) {
...
exports.register = function () {
    ko.components.register('c-details-task-statistics', {
        viewModel: {
