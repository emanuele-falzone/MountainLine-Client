...
function ViewModel(params) {
    var self = this;
    self._repository = params.context.repositories['CampaignImageDetails'];
...
ViewModel.prototype.id = 'details-campaign-image';
...
exports.register = function () {
    ko.components.register('c-details-campaign-image', {
        viewModel: {
